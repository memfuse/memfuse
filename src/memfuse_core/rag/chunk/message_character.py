...
class MessageCharacterChunkStrategy(ChunkStrategy):
    """Message-character based chunking strategy.
    ...
    3. Contextual Enhancement: Add context from previous chunks in the same session
    """
    ...
    def __init__(
        ...
        """Initialize the message-character chunking strategy.
        ...
        Args:
            ...
            gpt_model: GPT model for contextual descriptions (optional)
